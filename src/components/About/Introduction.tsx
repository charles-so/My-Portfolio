...
const Introduction: React.FC<IntroductionProps> = ({ scrollToBackground }) => {
  ...
  const introMessage: string = "I am a passionate software developer with a recent degree in computer science, specializing in areas such as computer networks, web development, and deployments.";
    ...
    <div className="flex flex-col items-center gap-32 pb-48">
      <div className="flex flex-col lg:flex-row items-center justify-center md:justify-between gap-10 lg:gap-32 md:gap-10 px-10">
        <div className="shrink-0">
          <img src={profilePicture} alt="ProfilePic" className="rounded-full h-80 w-50" />
        </div>
      ...
      <div>
        <div className="animate-bounce relative">
          <div className="hover:bg-black hover:text-white hover:rounded-lg py-2 px-6" onClick={scrollToBackground}>
